...
assert(/manifest\.json\?v=original-language-sources-20260710b/.test(dataServiceSource));
assert(/data-service\.js\?v=original-language-sources-20260710b/.test(appSource));
assert(/app\.js\?v=original-language-sources-20260710b/.test(indexSource));
